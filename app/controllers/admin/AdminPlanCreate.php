...
class AdminPlanCreate extends Controller {
    ...
    public function index() {
        ...
        if(!empty($_POST)) {
            ...
            $_POST['settings'] = [
                'devices_limit'                     => (int) $_POST['devices_limit'],
                'contacts_limit'                    => (int) $_POST['contacts_limit'],
                ...
                'sent_sms_per_month_limit'          => (int) $_POST['sent_sms_per_month_limit'],
                'teams_limit'                       => (int) $_POST['teams_limit'],
                'team_members_limit'                => (int) $_POST['team_members_limit'],
                'sms_retention'        => (int) $_POST['sms_retention'],
