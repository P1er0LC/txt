...
class Spotlight extends Controller {
    ...
    public function index() {
        ...
        if(is_logged_in()) {
            ...
            $available_pages[] = [
                'name' => l('devices.title'),
                'url'  => 'devices'
            ];

            $available_pages[] = [
                'name' => l('device_create.title'),
                'url'  => 'device-create'
            ];

            $available_pages[] = [
                'name' => l('contacts.title'),
                'url'  => 'contacts'
            ];

            $available_pages[] = [
                'name' => l('contact_create.title'),
                'url'  => 'contact-create'
            ];

            $available_pages[] = [
                'name' => l('contacts_import.title'),
                'url'  => 'contacts-import'
            ];

            $available_pages[] = [
                'name' => l('contacts_statistics.title'),
            ...
            if(user()->type == 1) {
                ...
                $available_pages[] = [
                    'name' => l('global.menu.admin') . ' - ' . l('admin_contacts.menu'),
                    'url'  => 'admin/contacts'
                ];
                $available_pages[] = [
                ...
                $available_pages[] = [
                    'name' => l('global.menu.admin') . ' - ' . l('admin_contacts_logs.menu'),
                    'url'  => 'admin/contacts-logs'
                ];
                $available_pages[] = [
