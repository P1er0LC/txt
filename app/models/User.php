...
class User extends Model {
    ...
    public function create(
        ...
        $preferences = json_encode([
            ...
            'contacts_default_order_by' => 'contact_id',
            'sms_default_order_by' => 'sms_id',
            'devices_default_order_by' => 'device_id',
            'campaigns_default_order_by' => 'campaign_id',
            'flows_default_order_by' => 'flow_id',
            'recurring_campaigns_default_order_by' => 'recurring_campaign_id',
            'rss_automations_default_order_by' => 'rss_automation_id',
            'segments_default_order_by' => 'segment_id',
