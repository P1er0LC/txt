...
return [
    ...
    'global.emails.user_campaigns_limit.body' => 'Hello <strong>{{NAME}}</strong>,<br /><br />This is a friendly notice you\'ve reached the campaigns per month limit of your plan. You won\'t be able to send any new SMS campaigns.<br /><br />Your <strong>{{PLAN_NAME}}</strong> plan allows <strong>{{CAMPAIGNS_LIMIT}}</strong> SMS campaigns per month.<br /><br /> To start sending new SMS campaigns, please renew your plan or upgrade to a higher one.<br /><br /><a href="{{USER_PLAN_RENEW_LINK}}" class="cta">Renew/upgrade plan</a><br /><br /> Regards,<br /> The {{WEBSITE_TITLE}} team.',

    'global.emails.user_sent_sms_limit.subject' => 'SMS limit has been reached - {{WEBSITE_TITLE}}',
    'global.emails.user_sent_sms_limit.body' => 'Hello <strong>{{NAME}}</strong>,<br /><br />This is a friendly notice you\'ve reached the SMS per month limit of your plan. You won\'t be able to send any SMS.<br /><br />Your <strong>{{PLAN_NAME}}</strong> plan allows <strong>{{SENT_SMS_LIMIT}}</strong> SMS per month.<br /><br /> To start sending new SMS, please renew your plan or upgrade to a higher one.<br /><br /><a href="{{USER_PLAN_RENEW_LINK}}" class="cta">Renew/upgrade plan</a><br /><br /> Regards,<br /> The {{WEBSITE_TITLE}} team.',
    ...
    'global.emails.user_new_sms.subject' => 'New SMS from \'{{PHONE_NUMBER}}\' - {{WEBSITE_TITLE}}',
    'global.emails.user_new_sms.body' => '<strong>{{PHONE_NUMBER}}</strong> has sent you a new SMS via <strong>{{DEVICE_NAME}}</strong> device.<br /><br />"{{MESSAGE}}"<br /><br /><a href="{{CONTACT_LINK}}" class="cta">View & reply</a><br /><br /> Regards,<br />The {{WEBSITE_TITLE}} team.',
    ...
    'global.notifications.user_campaigns_limit.description' => 'To continue sending SMS campaigns to your contacts, please %srenew/upgrade%s your plan.',

    'global.notifications.user_sent_sms_limit.title' => 'Monthly SMS limit has been reached.',
    'global.notifications.user_sent_sms_limit.description' => 'To continue sending SMS to your contacts, please %srenew/upgrade%s your plan.',
    ...
    'global.plan_settings.devices_limit' => '%s devices',
    'global.plan_settings.contacts_limit' => '%s contacts',
    'global.plan_settings.segments_limit' => '%s segments',
    'global.plan_settings.segments_limit_help' => 'Create & save accessible filters for your contacts.',
    'global.plan_settings.rss_automations_limit' => '%s RSS automations',
    'global.plan_settings.rss_automations_limit_help' => 'Parse RSS feeds and send SMS to your contacts automatically.',
    ...
    'global.plan_settings.flows_limit_help' => 'Set up automatic scheduled SMS deliveries after a new contact has been added.',
    'global.plan_settings.campaigns_per_month_limit' => '%s campaigns <span class="small text-muted">/ month</span>',
    'global.plan_settings.sent_sms_per_month_limit' => '%s sent SMS <span class="small text-muted">/ month</span>',
    'global.plan_settings.sms_retention' => '%s sms data retention',
    'global.plan_settings.analytics_is_enabled' => 'Analytics',
    'global.plan_settings.analytics_is_enabled_help' => 'Advanced analytics & tracking for your contacts, sms & devices.',
    ...
    'global.plan_settings.removable_branding_is_enabled' => 'No SMS branding',
    'global.plan_settings.removable_branding_is_enabled_help' => 'Completely remove our SMS branding when sending new SMS.',
    ...
    'account_preferences.sms_features' => 'SMS features',
    'account_preferences.stop_words' => 'Stop words',
    'account_preferences.stop_words_help' => 'If your contacts reply with one of these words, they will be automatically unsubscribed. Comma separated values.',
    'account_preferences.start_words' => 'Start words',
    'account_preferences.start_words_help' => 'If your contacts reply with one of these words, they will be automatically subscribed. Comma separated values.',
    ...
    'dashboard.sms.header' => 'Latest SMS',
    'dashboard.devices.header' => 'Latest devices',
    'dashboard.contacts.header' => 'Latest contacts',
    ...
    'dashboard.total_sms' => '%s SMS',
    'dashboard.total_devices' => '%s devices',
    'dashboard.total_contacts' => '%s contacts',
    'dashboard.total_campaigns' => '%s campaigns',
    'dashboard.total_sent_sms' => '%s sent SMS',


    'index.breadcrumb' => 'Home',
    'index.menu' => 'Home',
    'index.title' => 'Android SMS gateway',
    'index.meta_description' => '',
    'index.meta_keywords' => '',
    'index.header' => 'Send SMS from your Android phone',
    'index.subheader' => 'We\'ve sent over <strong>💬 %s SMS messages.</strong><br />Fast, reliable, and in your control.',
    'index.subheader2' => 'Fully featured API',
    ...
    'index.sms.name' => 'SMS',
    'index.sms.header' => 'Advanced SMS Delivery',
    'index.sms.subheader' => 'Powerful, feature-packed SMS sending solution.',
    'index.sms.scheduling' => 'Schedule SMS messages',
    'index.sms.custom_parameters' => 'Use custom dynamic parameters',
    'index.sms.spintax' => 'Supports Spintax formatting',
    'index.sms.bulk' => 'Send bulk SMS messages',
    'index.sms.api' => 'Fully API-ready for integration',

    'index.contacts.name' => 'Contacts',
    'index.contacts.header' => 'Contacts Management',
    'index.contacts.subheader' => 'Track, analyze, and optimize contacts for better SMS campaign results.',
    'index.contacts.location' => 'Continent & Country',
    'index.contacts.custom_parameters' => 'Custom contact parameters',
    'index.contacts.statistics' => 'Contact statistics',
    'index.contacts.logs' => 'Complete SMS send logs',
    'index.contacts.has_opted_out' => 'Opt-in and opt-out status',

    'index.campaigns.name' => 'Campaigns',
    'index.campaigns.header' => 'Fully featured SMS campaigns',
    'index.campaigns.subheader' => 'Prepare, schedule & send SMS campaigns to your contacts.',
    'index.campaigns.spintax' => 'Spintax support',
    'index.campaigns.custom_parameters' => 'Dynamic content with custom parameters',
    'index.campaigns.segments' => 'Send campaigns to a specific group of contacts',
    'index.campaigns.statistics' => 'Detailed insights after the campaign is sent',

    'index.flows.name' => 'Flows',
    'index.flows.header' => 'Automated series of SMS',
    'index.flows.subheader' => 'Set up automated notification flows for new contacts. Here are just a few examples.',
    'index.flows.one' => 'After 10 minutes: Welcome SMS',
    'index.flows.two' => 'After 1 day: Support & contact links SMS',
    'index.flows.three' => 'After 3 days: Premium trial package code',
    'index.flows.four' => 'After 10 days: Upgrade to paid plan 30% discount code',

    'index.rss_automations.name' => 'RSS automations',
    'index.rss_automations.header' => 'RSS to SMS',
    'index.rss_automations.subheader' => 'Automatically trigger SMS to be sent when your RSS feed gets new content.',
    'index.rss_automations.one' => 'Highly configurable RSS feed checks',
    'index.rss_automations.two' => 'Spread out RSS feed notifications with delays',
    'index.rss_automations.three' => 'Dynamic usage of RSS feed title, description & URLs',
    ...
    'index.segments.header' => 'Custom contact groups',
    'index.segments.subheader' => 'Create segments of contacts to easily access different type of users from your audience.',
    'index.segments.custom' => 'Custom CSV & bulk phone numbers',
    'index.segments.continents' => 'Continents filters',
    'index.segments.countries' => 'Countries filters',
    'index.segments.custom_parameters' => 'Filter by custom parameters',


    'index.tutorial.one' => 'Download APK & install.',
    'index.tutorial.one_text' => 'Install the app on your Android phone.',
    'index.tutorial.two' => 'Open app & connect.',
    'index.tutorial.two_text' => 'Insert your specified connection credentials.',
    'index.tutorial.three' => 'Automate SMS sending.',
    'index.tutorial.three_text' => 'You\'re ready to send SMS campaigns.',


    'index.stats' => '<span>%1$s devices</span> have sent more than <span>%2$s+ SMS</span> for <span>%3$s+ contacts</span>.',


    'index.notifications_handlers.header' => 'Get custom notifications on SMS replies',


    'index.statistics.header' => 'Contacts & SMS statistics',
    'index.statistics.subheader' => 'Track campaigns with real-time & detailed insights.',

    'index.receive_sms.header' => 'Track incoming SMS',
    'index.receive_sms.subheader' => 'Monitor and log all received messages in real time.',

    'index.contacts2.header' => 'Bulk custom contacts',
    'index.contacts2.subheader' => 'Import & tag contacts via CSV or copy/paste.',

    'index.devices.header' => 'Unlimited devices',
    'index.devices.subheader' => 'Connect any number of Android devices.',

    'index.export.header' => 'Data export',
    'index.export.subheader' => 'Export to CSV, JSON, or PDF in one click.',

    'index.app.header' => 'Optimized app',
    'index.app.subheader' => 'Fast & efficient app-to-web technology.',
    ...
    'index.cta.subheader' => 'Automate your SMS sending within minutes.',
    ...
    'api_documentation.contacts_statistics' => 'Contacts statistics',
    'api_documentation.contacts_statistics.start_date' => 'Start date in <code>Y-m-d</code> format.',
    'api_documentation.contacts_statistics.end_date' => 'End date in <code>Y-m-d</code> format.',

    'api_documentation.sms.phone_numbers' => 'One valid phone number per line or comma separated values (E.164 format).',
    ...
    'sms.breadcrumb' => 'SMS',
    'sms.header' => 'SMS',
    'sms.subheader' => 'All the sent & received SMS.',
    'sms.sms' => 'SMS',
    'sms.scheduled_datetime' => 'Scheduled datetime',
    'sms.send' => 'Send SMS',
    'sms.content' => 'SMS content',
    'sms.branding' => 'SMS footer branding',
    'sms.branding_help' => 'All the SMS that are sent out will contain this message in the footer.',
    'sms.sent' => 'Sent',
    'sms.received' => 'Received',
    'sms.pending' => 'Pending',
    'sms.failed' => 'Failed',
    'sms.is_scheduled' => 'Schedule SMS',
    'sms.no_data' => 'There are no SMS sent yet',
    'sms.no_data_help' => 'Start by sending a new SMS.',
    'sms.success_message.scheduled' => 'Scheduled %1$s SMS messages be sent in %2$s.',
    'sms.success_message.send' => '%s SMS messages will start to be processed.',

    'sms.simple_notification' => 'New SMS message from %1$s via \'%2$s\' device.%3$sView details: %4$s 🔗.',
    'sms.push_notification.title' => 'New SMS message',
    'sms.push_notification.description' => 'From %1$s via \'%2$s\' device.',


    'sms_create.breadcrumb' => 'Send a new SMS',
    'sms_create.title' => 'Send a new SMS',
    'sms_create.header' => 'Send a new SMS',
    ...
    'contacts.subheader' => 'Find & manage all your address book contacts.',
    'contacts.import' => 'Import contacts',
    'contacts.create' => 'Add contact',
    'contacts.no_data' => 'There are no contacts yet',
    'contacts.no_data_help' => 'Start by importing or creating new contacts.',
    'contacts.contacts' => 'Contacts',
    'contacts.contact' => 'Contact',
    'contacts.phone_number' => 'Phone number',
    'contacts.phone_number_placeholder' => '+12345678900',
    'contacts.last_sent_datetime' => 'Last sent SMS',
    'contacts.last_received_datetime' => 'Last received SMS',
    'contacts.x_sent_sms' => '%s sent SMS',
    'contacts.x_pending_sms' => '%s pending SMS',
    'contacts.x_failed_sms' => '%s failed SMS',
    'contacts.x_received_sms' => '%s received SMS',
    'contacts.total_sent_sms' => 'Total sent SMS',
    'contacts.total_pending_sms' => 'Total pending SMS',
    'contacts.total_failed_sms' => 'Total failed SMS',
    'contacts.total_received_sms' => 'Total received SMS',
    'contacts.total_contacts' => 'Total contacts',
    'contacts.has_opted_out' => 'Has opted out',
    'contacts.opted_out' => 'Opted out',
    'contacts.opted_in' => 'Opted in',
    'contacts.contact_id' => 'Contact ID',
    'contacts.custom_parameters' => 'Custom parameters',
    'contacts.custom_parameters_x' => '%s custom parameters',
    'contacts.custom_parameter_add' => 'Add parameter',
    'contacts.custom_parameter_key' => 'Key',
    'contacts.custom_parameter_value' => 'Value',
    'contacts.unknown_name' => 'Unknown name',
    'contacts.total' => 'Total contacts',


    'contact_create.breadcrumb' => 'Add contact',
    'contact_create.title' => 'Add contact',
    'contact_create.header' => 'Add contact',


    'contacts_import.breadcrumb' => 'Import contacts',
    'contacts_import.title' => 'Import contacts',
    'contacts_import.header' => 'Import contacts',
    'contacts_import.file' => 'CSV file',
    'contacts_import.file_help' => 'The CSV file must contain: <code>phone_number</code> column. Optional columns: <code>name</code>, <code>datetime</code>',
    'contacts_import.file_help2' => 'You can use the header row to add new custom parameters like <code>custom_parameters[name]</code>, and in each row that has this custom parameter, you fill that column.',
    'contacts_import.success_message' => '%s contacts have been successfully imported.',


    'contact_view.title' => 'Contact - %s',
    'contact_view.menu' => 'Contact',
    'contact_view.breadcrumb' => 'Contact',
    'contact_view.header' => '%s contact',
    'contact_view.subheader' => 'Here are all the details & chats of your contact.',
    'contact_view.logs' => 'Contact logs',
    'contact_view.stats' => 'Stats',
    'contact_view.advanced' => 'Advanced',


    'contact_update.breadcrumb' => 'Edit contact',
    'contact_update.title' => 'Edit contact',
    'contact_update.header' => 'Edit contact',
    ...
    'devices.sim_subscription_id' => 'SIM card',
    'devices.subheader' => 'Connect & manage your android devices as SMS gateways.',
    'devices.create' => 'Connect device',
    'devices.no_data' => 'There are no devices yet',
    'devices.no_data_help' => 'Start by connecting your first device.',
    'devices.last_ping_datetime' => 'Last ping datetime',
    'devices.connect' => 'Connect device',
    'devices.battery' => 'Battery',
    'devices.is_charging' => 'Charging',
    'devices.notifications_container' => 'Notifications',
    'devices.notifications' => 'SMS replies notifications',
    'devices.notifications_help' => 'Get notified when people send you messages or replies.',
    ...
    'device_create.breadcrumb' => 'Add device',
    'device_create.title' => 'Add device',
    'device_create.header' => 'Add device',
    'device_create.info' => 'In the next step you will be asked to connect your android device with our system.',


    'device_update.breadcrumb' => 'Edit device',
    'device_update.title' => 'Edit device',
    'device_update.header' => 'Edit device',


    'device.title' => 'Device - %s',
    'device.menu' => 'Device',
    'device.breadcrumb' => 'Device',
    'device.header' => '%s device',
    'device.subheader' => 'Here is all the data about your device, such as device details and sent SMS.',


    'device_connect_modal.header' => 'Connect your android',
    'device_connect_modal.first.header' => '1. Download & install',
    'device_connect_modal.first.subheader' => 'Get the <strong>SMS gateway app</strong> APK file and install it into your android device.',
    'device_connect_modal.second.header' => '2. Open app & connect',
    ...
    'contacts_statistics.breadcrumb' => 'Statistics',
    'contacts_statistics.title' => 'Contacts statistics',
    'contacts_statistics.title_dynamic' => 'Contacts statistics - %s',
    'contacts_statistics.menu' => 'Contacts statistics',
    'contacts_statistics.header_dynamic' => '%s statistics',
    'contacts_statistics.header' => 'Contacts statistics',
    'contacts_statistics.link' => 'Statistics',
    'contacts_statistics.overview' => 'Overview',
    'contacts_statistics.overview_help' => '',
    'contacts_statistics.data_preview' => 'Data preview',
    'contacts_statistics.data_preview_info' => 'Widgets data is based on the last %s entries. Click View more to see all the widget data.',
    'contacts_statistics.country_help' => 'Discover the countries that your contacts are from.',
    'contacts_statistics.continent_code_help' => 'Discover the continents that your contacts are from.',
    'contacts_statistics.city_name_from_country' => 'Cities of %s',
    'contacts_statistics.city_name_help' => 'Discover the cities that your contacts are from.',
    'contacts_statistics.has_opted_out' => 'Status',
    'contacts_statistics.has_opted_out_help' => 'Discover how many of your contacts have opted out.',
    'contacts_statistics.no_data' => 'There are no statistics available for this date range',
    'contacts_statistics.no_data_help' => 'Add new contacts or change your date range.',
    ...
    'campaigns.subheader' => 'All the sent SMS campaigns to your contacts.',
    ...
    'campaigns.no_data_help' => 'Start by creating & sending your first SMS campaign.',
    'campaigns.total_sent_sms' => 'Sent SMS',
    ...
    'campaigns.content_help' => 'It is recommended not to go over 300 characters. Depending on your carrier, it will be automatically truncated or fail if too long.',
    ...
    'campaigns.segment.all' => 'All contacts',
    'campaigns.segment.custom' => 'Contacts IDs CSV list',
    'campaigns.segment.bulk' => 'Bulk phone numbers',
    'campaigns.segment.filter' => 'Filtered data',
    'campaigns.phone_numbers' => 'Phone numbers',
    'campaigns.phone_numbers_help' => 'One valid phone number per line or comma separated values (E.164 format).',
    'campaigns.contacts_ids' => 'Contacts IDs',
    'campaigns.contacts_ids_placeholder' => '1,2,3',
    'campaigns.contacts_ids_help' => 'Comma separated values.',
    ...
    'campaigns.error_message.contacts_ids_is_null' => 'You must select at least one valid contact to send SMS.',
    ...
    'segments.subheader' => 'Create and manage segments/groups of your contacts for easy access.',
    'segments.no_data' => 'There are no sent segments yet',
    'segments.no_data_help' => 'Start by creating your first contacts segment.',
    'segments.segment' => 'Segment',
    'segments.type.custom' => 'Contacts IDs CSV list',
    'segments.type.bulk' => 'Bulk phone numbers',
    'segments.type.filter' => 'Filtered data',
    'segments.phone_numbers' => 'Phone numbers',
    'segments.phone_numbers_help' => 'One valid phone number per line (E.164 format).',
    'segments.contacts_ids' => 'Contacts IDs',
    'segments.contacts_ids_placeholder' => '1,2,3',
    'segments.contacts_ids_help' => 'Comma separated values.',
    ...
    'flows.flow' => 'Flow',
    'flows.subheader' => 'Create an automated flow of SMS for your contacts.',
    'flows.no_data' => 'There are no automated flows yet',
    'flows.no_data_help' => 'Start by creating your first contacts flow.',
    ...
    'rss_automations.subheader' => 'Automatically parse and send SMS messages to your contacts based on RSS feeds.',
    'rss_automations.no_data' => 'There are no RSS feeds yet',
    'rss_automations.no_data_help' => 'Start by attaching your first RSS feed & automate SMS messages.',
    ...
    'rss_automations.items_count_help' => 'Specify the number of unique recent items from your RSS feed to send SMS for.',
    'rss_automations.campaigns_delay' => 'Delay between SMS campaigns',
