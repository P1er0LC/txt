        ...
        <div class="card-body">
            ...
            <form id="form" action="" method="post" role="form" enctype="multipart/form-data">
                ...
                <div class="form-group" data-segment="custom">
                    <label for="contacts_ids"><i class="fas fa-fw fa-sm fa-address-book text-muted mr-1"></i> <?= l('campaigns.contacts_ids') ?></label>
                    <input type="text" id="contacts_ids" name="contacts_ids" value="<?= $data->values['contacts_ids'] ?>" class="form-control <?= \Altum\Alerts::has_field_errors('contacts_ids') ? 'is-invalid' : null ?>" placeholder="<?= l('campaigns.contacts_ids_placeholder') ?>" required="required" />
