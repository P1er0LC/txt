...
<nav class="navbar navbar-main navbar-expand-lg navbar-light border border-gray-200 mt-4 rounded-2x <?= \Altum\Router::$controller_key == 'index' ? null : 'mb-6' ?>">
    <div class="container">
        <a
                href="<?= url() ?>"
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <div class="d-flex flex-column flex-lg-row">
                                <div class="pr-lg-3">
                                    ...
                                    <a href="<?= url('contacts') ?>" class="dropdown-item"><i class="fas fa-fw fa-sm fa-address-book mr-2"></i> <?= l('contacts.menu') ?></a>

                                    <a href="<?= url('sms') ?>" class="dropdown-item"><i class="fas fa-fw fa-sm fa-comment mr-2"></i> <?= l('sms.menu') ?></a>

                                    <a href="<?= url('devices') ?>" class="dropdown-item"><i class="fas fa-fw fa-sm fa-mobile mr-2"></i> <?= l('devices.menu') ?></a>

                                    <a href="<?= url('campaigns') ?>" class="dropdown-item"><i class="fas fa-fw fa-sm fa-rocket mr-2"></i> <?= l('campaigns.menu') ?></a>

                                    <a href="<?= url('rss-automations') ?>" class="dropdown-item"><i class="fas fa-fw fa-sm fa-rss mr-2"></i> <?= l('rss_automations.menu') ?></a>

                                    <a href="<?= url('recurring-campaigns') ?>" class="dropdown-item"><i class="fas fa-fw fa-sm fa-retweet mr-2"></i> <?= l('recurring_campaigns.menu') ?></a>
