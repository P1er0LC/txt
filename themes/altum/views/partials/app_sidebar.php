...
<div class="app-sidebar">
    ...
    <div class="overflow-auto flex-grow-1">
        <ul class="app-sidebar-links">
            ...
            <li class="<?= in_array(\Altum\Router::$controller, ['Contacts', 'ContactCreate', 'ContactView', 'ContactUpdate', 'ContactsImport']) ? 'active' : null ?> d-flex">
                <a href="<?= url('contacts') ?>"><i class="fas fa-fw fa-sm fa-address-book mr-2"></i> <?= l('contacts.menu') ?></a>

                <a href="<?= url('contacts-statistics') ?>" class="<?= in_array(\Altum\Router::$controller, ['ContactsStatistics']) ? 'bg-primary text-white' : null ?> default w-auto ml-1" data-tooltip data-tooltip-hide-on-click title="<?= l('contacts_statistics.menu') ?>">
                    <i class="fas fa-fw fa-sm fa-chart-bar"></i>
                </a>
            </li>

            <li class="<?= in_array(\Altum\Router::$controller, ['Sms']) ? 'active' : null ?> d-flex">
                <a href="<?= url('sms') ?>"><i class="fas fa-fw fa-sm fa-comment mr-2"></i> <?= l('sms.menu') ?></a>

                <a href="<?=url('sms-create') ?>" class="<?= in_array(\Altum\Router::$controller, ['SmsCreate']) ? 'bg-primary text-white' : null ?> default w-auto ml-1" data-tooltip data-tooltip-hide-on-click title="<?= l('sms.send') ?>">
                    <i class="fas fa-fw fa-sm fa-plus-circle"></i>
                </a>
            </li>

            <li class="<?= in_array(\Altum\Router::$controller, ['Devices', 'DeviceUpdate', 'DeviceCreate', 'Device']) ? 'active' : null ?>">
                <a href="<?= url('devices') ?>"><i class="fas fa-fw fa-sm fa-mobile mr-2"></i> <?= l('devices.menu') ?></a>
            </li>
            ...
            <li class="<?= in_array(\Altum\Router::$controller, ['RssAutomation', 'RssAutomations', 'RssAutomationUpdate', 'RssAutomationCreate',]) ? 'active' : null ?>">
                <a href="<?= url('rss-automations') ?>"><i class="fas fa-fw fa-sm fa-rss mr-2"></i> <?= l('rss_automations.menu') ?></a>
            </li>

            <li class="<?= in_array(\Altum\Router::$controller, ['RecurringCampaign', 'RecurringCampaigns', 'RecurringCampaignUpdate', 'RecurringCampaignCreate',]) ? 'active' : null ?>">
                <a href="<?= url('recurring-campaigns') ?>"><i class="fas fa-fw fa-sm fa-retweet mr-2"></i> <?= l('recurring_campaigns.menu') ?></a>
            </li>

            <li class="<?= in_array(\Altum\Router::$controller, ['Flows', 'Flow', 'FlowUpdate', 'FlowCreate',]) ? 'active' : null ?>">
