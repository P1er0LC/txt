...
<div class="container">
    ...
    <div class="row mt-5">
        ...
        <div class="col-12 col-sm-6 col-xl-4 p-3 position-relative">
            <div class="card d-flex flex-row h-100 overflow-hidden">
                <div class="border-right border-gray-100 px-3 d-flex flex-column justify-content-center">
                    <a href="<?= url('api-documentation/contacts') ?>" class="stretched-link">
                        <i class="fas fa-fw fa-address-book text-primary-600"></i>
                    </a>
                </div>
        ...
        <div class="col-12 col-sm-6 col-xl-4 p-3 position-relative">
            <div class="card d-flex flex-row h-100 overflow-hidden">
                <div class="border-right border-gray-100 px-3 d-flex flex-column justify-content-center">
                    <a href="<?= url('api-documentation/contacts-statistics') ?>" class="stretched-link">
                        <i class="fas fa-fw fa-chart-bar text-primary-600"></i>
                    </a>
                </div>

                <div class="card-body d-flex align-items-center">
                    <?= l('contacts_statistics.title') ?>
                </div>
            </div>
        </div>
        ...
        <div class="col-12 col-sm-6 col-xl-4 p-3 position-relative">
            <div class="card d-flex flex-row h-100 overflow-hidden">
                <div class="border-right border-gray-100 px-3 d-flex flex-column justify-content-center">
                    <a href="<?= url('api-documentation/sms') ?>" class="stretched-link">
                        <i class="fas fa-fw fa-comments text-primary-600"></i>
                    </a>
                </div>
        ...
        <div class="col-12 col-sm-6 col-xl-4 p-3 position-relative">
            <div class="card d-flex flex-row h-100 overflow-hidden">
                <div class="border-right border-gray-100 px-3 d-flex flex-column justify-content-center">
                    <a href="<?= url('api-documentation/devices') ?>" class="stretched-link">
                        <i class="fas fa-fw fa-mobile text-primary-600"></i>
                    </a>
                </div>
