        ...
        <form action="" method="post" role="form">
            ...
            <div>
                <div class="form-group">
                    ...
                    <input type="number" id="contacts_limit" name="contacts_limit" min="-1" class="form-control" value="0" required="required" />
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="devices_limit" name="devices_limit" min="-1" class="form-control" value="0" required="required" />
                    <small class="form-text text-muted"><?= l('admin_plans.plan.unlimited') ?></small>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="sent_sms_per_month_limit" name="sent_sms_per_month_limit" min="-1" class="form-control" value="0" />
                    <small class="form-text text-muted"><?= l('admin_plans.plan.unlimited') ?></small>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="number" id="sms_retention" name="sms_retention" min="-1" class="form-control" value="0" required="required" />
                        <div class="input-group-append">
