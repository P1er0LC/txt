    ...
    <div class="card-body">
        ...
        <form action="" method="post" role="form" enctype="multipart/form-data">
            ...
            <div id="plan_settings" style="display: none">
                ...
                <div class="form-group">
                    <label for="contacts_limit"><?= l('admin_plans.plan.contacts_limit') ?></label>
                    <input type="number" id="contacts_limit" name="contacts_limit" min="-1" class="form-control" value="<?= $data->user->plan_settings->contacts_limit ?>" />
                    <small class="form-text text-muted"><?= l('admin_plans.plan.unlimited') ?></small>
                </div>

                <div class="form-group">
                    <label for="devices_limit"><?= l('admin_plans.plan.devices_limit') ?></label>
                    <input type="number" id="devices_limit" name="devices_limit" min="-1" class="form-control" value="<?= $data->user->plan_settings->devices_limit ?>" />
                    <small class="form-text text-muted"><?= l('admin_plans.plan.unlimited') ?></small>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="campaigns_per_month_limit" name="campaigns_per_month_limit" min="-1" class="form-control" value="<?= $data->user->plan_settings->campaigns_per_month_limit ?>" />
                    <small class="form-text text-muted"><?= l('admin_plans.plan.unlimited') ?></small>
                </div>

                <div class="form-group">
                    <label for="sent_sms_per_month_limit"><?= l('admin_plans.plan.sent_sms_per_month_limit') ?> <small class="form-text text-muted"><?= l('admin_plans.plan.per_month') ?></small></label>
                    <input type="number" id="sent_sms_per_month_limit" name="sent_sms_per_month_limit" min="-1" class="form-control" value="<?= $data->user->plan_settings->sent_sms_per_month_limit ?>" />
                    <small class="form-text text-muted"><?= l('admin_plans.plan.unlimited') ?></small>
                </div>

                <div class="form-group">
                    <label for="rss_automations_limit"><?= l('admin_plans.plan.rss_automations_limit') ?></label>
                    <input type="number" id="rss_automations_limit" name="rss_automations_limit" min="-1" class="form-control" value="<?= $data->user->plan_settings->rss_automations_limit ?>" />
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="recurring_campaigns_limit" name="recurring_campaigns_limit" min="-1" class="form-control" value="<?= $data->user->plan_settings->recurring_campaigns_limit ?>" />
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="segments_limit" name="segments_limit" min="-1" class="form-control" value="<?= $data->user->plan_settings->segments_limit ?>" />
                    <small class="form-text text-muted"><?= l('admin_plans.plan.unlimited') ?></small>
                </div>

                <div class="form-group">
                    <label for="flows_limit"><?= l('admin_plans.plan.flows_limit') ?></label>
                    <input type="number" id="flows_limit" name="flows_limit" min="-1" class="form-control" value="<?= $data->user->plan_settings->flows_limit ?>" />
                    <small class="form-text text-muted"><?= l('admin_plans.plan.unlimited') ?></small>
                </div>

                <div class="form-group">
                    <label for="sms_retention"><?= l('admin_plans.plan.sms_retention') ?></label>
                    <div class="input-group">
                        <input type="number" id="sms_retention" name="sms_retention" min="-1" class="form-control" value="<?= $data->user->plan_settings->sms_retention ?>" />
                        <div class="input-group-append">
                            <span class="input-group-text"><?= l('global.date.days') ?></span>
                        </div>
                    </div>
                    <small class="form-text text-muted"><?= l('admin_plans.plan.sms_retention_help') ?></small>
                </div>
