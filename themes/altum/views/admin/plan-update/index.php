        ...
        <form action="" method="post" role="form">
            ...
            <div>
                <div class="form-group">
                    ...
                    <input type="number" id="contacts_limit" name="contacts_limit" min="-1" class="form-control" value="<?= $data->plan->settings->contacts_limit ?>" <?= $data->plan_id == 'guest' ? 'disabled="disabled"' : null ?> />
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="devices_limit" name="devices_limit" min="-1" class="form-control" value="<?= $data->plan->settings->devices_limit ?>" <?= $data->plan_id == 'guest' ? 'disabled="disabled"' : null ?> />
                    <small class="form-text text-muted"><?= l('admin_plans.plan.unlimited') ?></small>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="sent_sms_per_month_limit" name="sent_sms_per_month_limit" min="-1" class="form-control" value="<?= $data->plan->settings->sent_sms_per_month_limit ?>" />
                    <small class="form-text text-muted"><?= l('admin_plans.plan.unlimited') ?></small>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="number" id="sms_retention" name="sms_retention" min="-1" class="form-control" value="<?= $data->plan->settings->sms_retention ?>" <?= $data->plan_id == 'guest' ? 'disabled="disabled"' : null ?> />
                        <div class="input-group-append">
