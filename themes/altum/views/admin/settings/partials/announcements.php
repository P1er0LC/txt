...
<div id="announcements">
    ...
    <div class="tab-content">
        <div class="tab-pane fade show active" id="pills-guests" role="tabpanel" aria-labelledby="pills-guests-tab">
            ...
            <div class="collapse" data-parent="#announcement" id="guests_content_translate_container">
        ...
        <div class="tab-pane fade" id="pills-users" role="tabpanel" aria-labelledby="pills-users-tab">
            ...
            <div class="collapse" data-parent="#announcement" id="users_content_translate_container">
                <div class="p-3 bg-gray-50 rounded mb-4">
                    <?php foreach(\Altum\Language::$active_languages as $language_name => $language_code): ?>
                        <div class="form-group">
