    ...
    <div class="mb-3 mb-xl-0 col-12 col-xl-4 order-xl-1">
        <div class="d-xl-none">
            <select class="custom-select" onchange="if(this.value) window.location.href=this.value">
                ...
                <option value="<?= url('admin/settings/sms') ?>" class="nav-link" <?= $data->method == 'sms' ? 'selected="selected"' : null ?>>💬 <?= l('admin_settings.sms.tab') ?></option>
        ...
        <div class="card d-none d-xl-flex">
            <div class="card-body">
                <div class="nav flex-column nav-pills" role="tablist" aria-orientation="vertical">
                    ...
                    <a class="nav-link <?= $data->method == 'sms' ? 'active' : null ?>" href="<?= url('admin/settings/sms') ?>"><i class="fas fa-fw fa-sm fa-comment mr-2"></i> <?= l('admin_settings.sms.tab') ?></a>
