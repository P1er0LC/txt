    ...
    <div class="mb-3 mb-xl-0 col-12 col-xl-4 order-xl-1">
        <div class="d-xl-none">
            <select class="custom-select" onchange="if(this.value) window.location.href=this.value">
                ...
                <?php endif ?>
                <option value="<?= url('admin/statistics/contacts?start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" <?= $data->type == 'contacts' ? 'selected' : null ?>>✅ <?= l('admin_contacts.menu') ?></option>
                <option value="<?= url('admin/statistics/sms?start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" <?= $data->type == 'sms' ? 'selected' : null ?>>💬 <?= l('admin_sms.menu') ?></option>
                <option value="<?= url('admin/statistics/devices?start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" <?= $data->type == 'devices' ? 'selected' : null ?>>📱 <?= l('admin_devices.menu') ?></option>
        ...
        <div class="card d-none d-xl-flex">
            <div class="card-body">
                <div class="nav flex-column nav-pills">
                    ...
                    <?php endif ?>
                    <a class="nav-link <?= $data->type == 'contacts' ? 'active' : null ?>" href="<?= url('admin/statistics/contacts?start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>"><i class="fas fa-fw fa-sm fa-address-book mr-1"></i> <?= l('admin_contacts.menu') ?></a>
                    <a class="nav-link <?= $data->type == 'sms' ? 'active' : null ?>" href="<?= url('admin/statistics/sms?start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>"><i class="fas fa-fw fa-sm fa-comment mr-1"></i> <?= l('admin_sms.menu') ?></a>
                    <a class="nav-link <?= $data->type == 'devices' ? 'active' : null ?>" href="<?= url('admin/statistics/devices?start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>"><i class="fas fa-fw fa-sm fa-mobile mr-1"></i> <?= l('admin_devices.menu') ?></a>
