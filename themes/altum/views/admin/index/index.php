        ...
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body">
                ...
                <div class="mt-2 text-break">
                    <a href="<?= url('admin/devices') ?>" class="stretched-link text-reset text-decoration-none">
                        <span class="h4" id="devices">
                            <span class="spinner-border spinner-border-sm" role="status"></span>
                        </span>
                    </a>

                    <div class="mt-1 small text-muted">
                        <span id="devices_current_month">
                            <span class="spinner-border spinner-border-sm" role="status"></span>
                        </span>
        ...
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body">
                <div class="row">
                    <div class="col text-truncate">
                        <small class="text-muted font-weight-bold">
                            <?= l('admin_contacts.menu') ?>
                        </small>
                    </div>
                    <div class="col-auto">
                    <span class="p-2 bg-primary-100 rounded">
                        <i class="fas fa-fw fa-sm fa-address-book text-primary"></i>
                    </span>
                    </div>
                </div>
                <div class="mt-2 text-break">
                    <a href="<?= url('admin/contacts') ?>" class="stretched-link text-reset text-decoration-none">
                        <span class="h4" id="contacts">
                            <span class="spinner-border spinner-border-sm" role="status"></span>
                        </span>
                    </a>

                    <div class="mt-1 small text-muted">
                        <span id="contacts_current_month">
                            <span class="spinner-border spinner-border-sm" role="status"></span>
                        </span>
                        <?= mb_strtolower(l('global.date.this_month')) ?>
                    </div>
    ...
    <div class="col-12 col-sm-6 col-xl-3 p-3 position-relative">
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body">
                ...
                <div class="mt-2 text-break">
                    <a href="<?= url('admin/sms') ?>" class="stretched-link text-reset text-decoration-none">
                        <span class="h4" id="total_sent_sms">
                            <span class="spinner-border spinner-border-sm" role="status"></span>
                        </span>
                    </a>

                    <div class="mt-1 small text-muted">
                        <span id="sent_sms_current_month">
                            <span class="spinner-border spinner-border-sm" role="status"></span>
                        </span>
                        <?= mb_strtolower(l('global.date.this_month')) ?>
                    </div>
    ...
    <div class="col-12 col-sm-6 col-xl-3 p-3 position-relative">
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body">
                ...
                <div class="mt-2 text-break">
                    <a href="<?= url('admin/sms') ?>" class="stretched-link text-reset text-decoration-none">
                        <span class="h4" id="total_received_sms">
                            <span class="spinner-border spinner-border-sm" role="status"></span>
                        </span>
                    </a>

                    <div class="mt-1 small text-muted">
                        <span id="received_sms_current_month">
                            <span class="spinner-border spinner-border-sm" role="status"></span>
                        </span>
                        <?= mb_strtolower(l('global.date.this_month')) ?>
                    </div>
        ...
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body">
                <div class="row">
                    <div class="col text-truncate">
                        <small class="text-muted font-weight-bold">
                            <?= l('admin_campaigns.menu') ?>
                        </small>
                    </div>
                    <div class="col-auto">
                    <span class="p-2 bg-primary-100 rounded">
                        <i class="fas fa-fw fa-sm fa-rocket text-primary"></i>
                    </span>
                    </div>
                </div>
                ...
                <div class="mt-2 text-break">
                    <a href="<?= url('admin/sms') ?>" class="stretched-link text-reset text-decoration-none">
                        <span class="h4" id="campaigns">
                            <span class="spinner-border spinner-border-sm" role="status"></span>
                        </span>
                    </a>

                    <div class="mt-1 small text-muted">
                        <span id="campaigns_current_month">
                            <span class="spinner-border spinner-border-sm" role="status"></span>
                        </span>
                        <?= mb_strtolower(l('global.date.this_month')) ?>
                    </div>
...
<script>
    ...
    (async function fetch_statistics() {
        ...
        if(data.status == 'error') {
            ...
            document.querySelector('#devices').innerHTML = data.details.devices ? nr(data.details.devices) : 0;
            document.querySelector('#devices_current_month').innerHTML = data.details.devices_current_month ? nr(data.details.devices_current_month) : 0;

            document.querySelector('#contacts').innerHTML = data.details.contacts ? nr(data.details.contacts) : 0;
            document.querySelector('#contacts_current_month').innerHTML = data.details.contacts_current_month ? nr(data.details.contacts_current_month) : 0;

            document.querySelector('#campaigns').innerHTML = data.details.campaigns ? nr(data.details.campaigns) : 0;
            document.querySelector('#campaigns_current_month').innerHTML = data.details.campaigns_current_month ? nr(data.details.campaigns_current_month) : 0;

            document.querySelector('#total_received_sms').innerHTML = data.details.total_sms.received ? nr(data.details.total_sms.received) : 0;
            document.querySelector('#received_sms_current_month').innerHTML = data.details.sms_current_month.received ? nr(data.details.sms_current_month.received) : 0;

            document.querySelector('#total_sent_sms').innerHTML = data.details.total_sms.sent ? nr(data.details.total_sms.sent) : 0;
            document.querySelector('#sent_sms_current_month').innerHTML = data.details.sms_current_month.sent ? nr(data.details.sms_current_month.sent) : 0;
