...
<div class="container">
            ...
            <div class="col-12 col-md-4 p-3 text-truncate">
                <div class="card d-flex flex-row h-100 overflow-hidden" data-toggle="tooltip" data-html="true" title="<?= l('contacts.last_sent_datetime') . ($data->flow->last_sent_datetime ? '<br />' . \Altum\Date::get($data->flow->last_sent_datetime, 2) . '<br /><small>' . \Altum\Date::get($data->flow->last_sent_datetime, 3) . '</small>' . '<br /><small>(' . \Altum\Date::get_timeago($data->flow->last_sent_datetime) . ')</small>' : '<br />' . l('global.na')) ?>">
                    ...
                    <div class="card-body text-truncate">
                        <?= $data->flow->last_sent_datetime ? \Altum\Date::get_timeago($data->flow->last_sent_datetime) : l('global.na') ?>
                    </div>
                </div>
            </div>

            <div class="col-12 col-md-4 p-3 text-truncate">
                <div class="card d-flex flex-row h-100 overflow-hidden" data-toggle="tooltip" data-html="true" title="<?= sprintf(l('global.datetime_tooltip'), '<br />' . \Altum\Date::get($data->flow->datetime, 2) . '<br /><small>' . \Altum\Date::get($data->flow->datetime, 3) . '</small>' . '<br /><small>(' . \Altum\Date::get_timeago($data->flow->datetime) . ')</small>') ?>">
                    <div class="pl-3 d-flex flex-column justify-content-center">
                        <div class="p-2 rounded-2x index-widget-icon d-flex align-items-center justify-content-center bg-gray-100">
                    ...
                    <div class="card-body text-truncate">
                        <?= $data->flow->datetime ? \Altum\Date::get_timeago($data->flow->datetime) : l('global.na') ?>
                    </div>
                </div>
            </div>

            <div class="col-12 col-md-4 p-3 text-truncate">
                <div class="card d-flex flex-row h-100 overflow-hidden" data-toggle="tooltip" data-html="true" title="<?= sprintf(l('global.last_datetime_tooltip'), ($data->flow->last_datetime ? '<br />' . \Altum\Date::get($data->flow->last_datetime, 2) . '<br /><small>' . \Altum\Date::get($data->flow->last_datetime, 3) . '</small>' . '<br /><small>(' . \Altum\Date::get_timeago($data->flow->last_datetime) . ')</small>' : '<br />' . l('global.na'))) ?>">
                    <div class="pl-3 d-flex flex-column justify-content-center">
                        <div class="p-2 rounded-2x index-widget-icon d-flex align-items-center justify-content-center bg-gray-100">
                    ...
                    <div class="card-body text-truncate">
                        <?= $data->flow->last_datetime ? \Altum\Date::get_timeago($data->flow->last_datetime) : l('global.na') ?>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-12 col-sm-6 p-3 text-truncate">
                <div class="card d-flex flex-row h-100 overflow-hidden position-relative" data-toggle="tooltip" title="<?= l('contacts.total_sent_sms') ?>">
                    <div class="pl-3 d-flex flex-column justify-content-center">
                        <div class="p-2 rounded-2x index-widget-icon d-flex align-items-center justify-content-center bg-gray-100">
                            <a href="<?= url('sms?status=sent&flow_id=' . $data->flow->flow_id) ?>" class="stretched-link">
            ...
            <div class="col-12 col-sm-6 p-3 text-truncate">
                <div class="card d-flex flex-row h-100 overflow-hidden" data-toggle="tooltip" title="<?= l('campaigns.segment') ?>">
                    ...
                    <div class="card-body text-truncate">
                        <?php if(is_numeric($data->flow->segment)): ?>
                            <a href="<?= url('segment-update/' . $data->flow->segment) ?>">
        ...
        <div class="row">
            <div class="col-12 col-sm-6 p-3 text-truncate">
                <div class="card d-flex flex-row h-100 overflow-hidden position-relative" data-toggle="tooltip" title="<?= l('contacts.total_pending_sms') ?>">
                    <div class="pl-3 d-flex flex-column justify-content-center">
                        <div class="p-2 rounded-2x index-widget-icon d-flex align-items-center justify-content-center bg-gray-100">
                            <a href="<?= url('sms?status=pending&flow_id=' . $data->flow->flow_id) ?>" class="stretched-link">
                                <i class="fas fa-fw fa-sm fa-spinner <?= $data->flow->total_pending_sms ? 'fa-spin' : null ?> text-gray-900"></i>
                            </a>
                        </div>
                    </div>

                    <div class="card-body text-truncate">
                        <?= nr($data->flow->total_pending_sms) ?>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 p-3 text-truncate">
                <div class="card d-flex flex-row h-100 overflow-hidden position-relative" data-toggle="tooltip" title="<?= l('contacts.total_failed_sms') ?>">
                    <div class="pl-3 d-flex flex-column justify-content-center">
                        <div class="p-2 rounded-2x index-widget-icon d-flex align-items-center justify-content-center bg-gray-100">
                            <a href="<?= url('sms?status=failed&flow_id=' . $data->flow->flow_id) ?>" class="stretched-link">
    ...
    <div class="mt-4 mb-5">
        <div class="d-flex align-items-center mb-3">
            ...
            <div class="ml-3">
                <a href="<?= url('sms?flow_id=' . $data->flow->flow_id) ?>" class="btn btn-sm btn-light" data-toggle="tooltip" title="<?= l('global.view_all') ?>"><i class="fas fa-fw fa-comment fa-sm"></i></a>
            </div>
        </div>
    ...
    <div class="mt-4 mb-5">
        ...
        <div class="table-responsive table-custom-container">
            <table class="table table-custom">
                ...
                <?php $device = $data->devices[$data->flow->device_id]; ?>
                <tr>
                    <td class="font-weight-bold text-truncate text-muted">
                ...
                <?php $sim = array_values(array_filter($device->sims, fn($sim) => $sim->subscription_id == $data->flow->sim_subscription_id))[0] ?? null; ?>
                <tr>
                    <td class="font-weight-bold text-truncate text-muted">
